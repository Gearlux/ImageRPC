...
class RotateStub(object):
  ...
  def __init__(self, channel):
    ...
    self.raw_rot90 = channel.unary_unary(
        '/Rotate/raw_rot90',
        request_serializer=image__pb2.raw_image.SerializeToString,
        response_deserializer=image__pb2.raw_image.FromString,
        )
...
def add_RotateServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'raw_rot90': grpc.unary_unary_rpc_method_handler(
          servicer.raw_rot90,
          request_deserializer=image__pb2.raw_image.FromString,
          response_serializer=image__pb2.raw_image.SerializeToString,
      ),
  }
